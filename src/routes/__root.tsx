...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      ...
      {
        src: "https://www.googletagmanager.com/gtag/js?id=AW-18301235621",
        async: true,
      },
      {
...
})(window,document,'script','dataLayer','GTM-MQ5KM3JD');`,
      },
    ],
  }),
  ...
  return (
    <html lang="en">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-MQ5KM3JD"
            height="0"
            width="0"
